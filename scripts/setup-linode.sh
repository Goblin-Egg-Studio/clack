...
echo "   2. Click your profile icon (top right) → API Tokens"
echo "   3. Click 'Create Personal Access Token'"
echo "   4. Give it a name like 'GitHub Actions Deploy'"
echo "   5. Set expiration (recommended: 1 year)"
echo "   6. Copy the token (you won't see it again!)"
echo ""
echo "To get your Instance ID:"
echo "   1. Go to https://cloud.linode.com → Linodes"
echo "   2. Click on your server"
echo "   3. Copy the ID from the URL (e.g., linode.com/linodes/123456)"
echo ""
